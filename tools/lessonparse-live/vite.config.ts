// Builds tools/lessonparse-live/probe.ts into something node can run, so the
...
export default defineConfig({
  ...
  build: {
    lib: { entry: 'tools/lessonparse-live/probe.ts', formats: ['es'], fileName: () => 'probe.mjs' },
    outDir: 'tools/lessonparse-live/dist',
    emptyOutDir: true,
    minify: false,
    target: 'node20',
