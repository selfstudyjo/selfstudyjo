...
const icons: Record<IconName, any> = {
  ...
  /* The three lab sandboxes. */
  database: filled('DatabaseIcon',
    'M12 2C7.58 2 4 3.34 4 5v14c0 1.66 3.58 3 8 3s8-1.34 8-3V5c0-1.66-3.58-3-8-3zm0 2c3.87 0 6 1.05 6 1s-2.13 1-6 1-6-1.05-6-1 2.13-1 6-1zm6 15c0 .05-2.13 1-6 1s-6-.95-6-1v-2.23C7.61 17.55 9.72 18 12 18s4.39-.45 6-1.23V19zm0-4.5c0 .05-2.13 1-6 1s-6-.95-6-1v-2.27C7.61 13.05 9.72 13.5 12 13.5s4.39-.45 6-1.27v2.27zm0-4.5c0 .05-2.13 1-6 1s-6-.95-6-1V7.77C7.61 8.55 9.72 9 12 9s4.39-.45 6-1.23V10z'),
  terminal: stroked('TerminalIcon', '1.9', () => [
    h('rect', { x: '2.5', y: '4', width: '19', height: '16', rx: '2' }),
    h('path', { d: 'M6.5 9.5l3 2.5-3 2.5M12.5 15h5' }),
  ]),
  python: stroked('PythonIcon', '1.8', () => [
    h('path', { d: 'M9 8.5L5.5 12 9 15.5M15 8.5l3.5 3.5L15 15.5' }),
    h('path', { d: 'M13.2 5.5l-2.4 13' }),
  ]),
};
