import{t as e}from"./shaderStore-TtV58TPX.js";var t=`bonesDeclaration`,n=`#if NUM_BONE_INFLUENCERS>0
...
#endif
`;e.IncludesShadersStore[a]||(e.IncludesShadersStore[a]=o);var s=`morphTargetsVertexGlobalDeclaration`,c=`#ifdef MORPHTARGETS
...
#endif
#endif
`;e.IncludesShadersStore[s]||(e.IncludesShadersStore[s]=c);var l=`morphTargetsVertexDeclaration`,u=`#ifdef MORPHTARGETS
...
#endif
#endif
`;e.IncludesShadersStore[l]||(e.IncludesShadersStore[l]=u);var d=`morphTargetsVertexGlobal`,f=`#ifdef MORPHTARGETS
#ifdef MORPHTARGETS_TEXTURE
float vertexID;
#endif
#endif
`;e.IncludesShadersStore[d]||(e.IncludesShadersStore[d]=f);var p=`morphTargetsVertex`,m=`#ifdef MORPHTARGETS
#ifdef MORPHTARGETS_TEXTURE
#if {X}==0
...
#endif
#endif
`;e.IncludesShadersStore[p]||(e.IncludesShadersStore[p]=m);var h=`instancesVertex`,g=`#ifdef INSTANCES
...
#endif
#endif
`;e.IncludesShadersStore[h]||(e.IncludesShadersStore[h]=g);var _=`bonesVertex`,v=`#ifndef BAKED_VERTEX_ANIMATION_TEXTURE
...
#endif
#endif
`;e.IncludesShadersStore[_]||(e.IncludesShadersStore[_]=v);var y=`bakedVertexAnimation`,b=`#ifdef BAKED_VERTEX_ANIMATION_TEXTURE
{
#ifdef INSTANCES
...
#endif
`;e.IncludesShadersStore[y]||(e.IncludesShadersStore[y]=b);var x=`clipPlaneVertex`,S=`#ifdef CLIPPLANE
