import{t as e}from"./shaderStore-T2b-z9pM.js";import"./clipPlaneFragment-BpKLJP_e.js";import"./packingFunctions-C02z643q.js";var t=`bayerDitherFunctions`,n=`fn bayerDither2(_P: vec2f)->f32 {return ((2.0*_P.y+_P.x+1.0)%(4.0));}
...
}`;e.ShadersStoreWGSL[s]||(e.ShadersStoreWGSL[s]=c);const l={name:s,shader:c};export{l as shadowMapPixelShaderWGSL};