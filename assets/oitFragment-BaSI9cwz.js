import{t as e}from"./shaderStore-TtV58TPX.js";var t=`decalFragmentDeclaration`,n=`#ifdef DECAL
...
#endif
result.Diffuse=LTCEvaluateWithEmission( normal,viewDir,position,mat3( 1.0 ),rectCoords,texFilteredMap );return result;}`;e.IncludesShadersStore[d]||(e.IncludesShadersStore[d]=f);var p=`clusteredLightingFunctions`,m=`struct ClusteredLight {vec4 vLightData;vec4 vLightDiffuse;vec4 vLightSpecular;vec4 vLightDirection;vec4 vLightFalloff;};
#define inline
...
`;e.IncludesShadersStore[p]||(e.IncludesShadersStore[p]=m);var h=`shadowsFragmentFunctions`,g=`#ifdef SHADOWS
...
#endif
#endif
`;e.IncludesShadersStore[h]||(e.IncludesShadersStore[h]=g);var _=`samplerFragmentDeclaration`,v=`#ifdef _DEFINENAME_
...
#endif
`;e.IncludesShadersStore[_]||(e.IncludesShadersStore[_]=v);var y=`reflectionFunction`,b=`vec3 computeFixedEquirectangularCoords(vec4 worldPos,vec3 worldNormal,vec3 direction)
...
#endif
`;e.IncludesShadersStore[y]||(e.IncludesShadersStore[y]=b);var x=`imageProcessingDeclaration`,S=`#ifdef EXPOSURE
...
#endif
`;e.IncludesShadersStore[x]||(e.IncludesShadersStore[x]=S);var C=`imageProcessingFunctions`,w=`#if defined(COLORGRADING) && !defined(COLORGRADING3D)
/** 
...
return result;}`;e.IncludesShadersStore[C]||(e.IncludesShadersStore[C]=w);var T=`bumpFragmentMainFunctions`,E=`#if defined(BUMP) || defined(CLEARCOAT_BUMP) || defined(ANISOTROPIC) || defined(DETAIL)
...
#endif
`;e.IncludesShadersStore[T]||(e.IncludesShadersStore[T]=E);var D=`bumpFragmentFunctions`,O=`#if defined(BUMP)
...
#endif
`;e.IncludesShadersStore[D]||(e.IncludesShadersStore[D]=O);var k=`fogFragmentDeclaration`,A=`#ifdef FOG
...
#endif
#endif
`;e.IncludesShadersStore[L]||(e.IncludesShadersStore[L]=R);var z=`logDepthFragment`,B=`#ifdef LOGARITHMICDEPTH
gl_FragDepthEXT=log2(vFragmentDepth)*logarithmicDepthConstant*0.5;
#endif
`;e.IncludesShadersStore[z]||(e.IncludesShadersStore[z]=B);var V=`fogFragment`,H=`#ifdef FOG
